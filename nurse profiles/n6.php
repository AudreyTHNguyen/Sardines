...
<div class="card-body">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <form method="post" action="n6.php">
                        <?php include('errors.php'); ?>
                        <!-- PAGEID MUST BE HARDCODED -->
                        <input type="hidden" name="pageID" value="n6.php">
                    ...
                    <?php
                        listComments('n6.php') //VARIABLE MUST BE SAME AS pageID
                    ?>
