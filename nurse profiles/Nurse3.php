...
<div class="card-body">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <form method="post" action="Nurse3.php">
                        <?php include('errors.php'); ?>
                        <!-- PAGEID MUST BE HARDCODED -->
                        <input type="hidden" name="pageID" value="Nurse3.php">
                    ...
                    <?php
                        listComments('Nurse3.php') //VARIABLE MUST BE SAME AS pageID
                    ?>
