...
<div class="card-body">
                ...
                <form action="mail_handler.php" method="post">
                        ...
                        <input type="text" name="first_name" placeholder="Your name.." style="width: 200px;" >
                        <div><label for="last_name">Last Name</label></div>
                        <input type="text" name="last_name" placeholder="Your last name.." style="width: 200px;" >

                        <div><label for="email">Email</label></div>
                        <input type="text" name="email" placeholder="Your email.." style="width: 200px;">
                         <div><label for="time">Time Request</label></div>
                        <input type="text" name="time" placeholder="Time request.." style="width: 200px;">
                        
                        <div><label for="message">Questions? </label></div>
                        <textarea name="message" cols="18" rows="5" placeholder="Your text.."></textarea>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <form method="post" action="n9.php">
                        <?php include('errors.php'); ?>
                        <!-- PAGEID MUST BE HARDCODED -->
                        <input type="hidden" name="pageID" value="n9.php">
                    ...
                    <?php
                        listComments('n9.php') //VARIABLE MUST BE SAME AS pageID
                    ?>
